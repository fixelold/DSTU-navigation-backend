INSERT INTO auditorium (number, id_sector) VALUES
    (unnest(array['1-319а', '1-319', '1-317а', '1-317', '1-319б', '1-320', '1-321', '1-321а', '1-315', '1-313', '1-323']), 3);

INSERT INTO auditorium (number, id_sector) VALUES
    (unnest(array['1-325', '1-326', '1-326а', '1-326в', '1-326б', '1-327а', '1-327', '1-328', '1-340', '341', '1-343', '1-344', '1-346', '1-347а', '1-347', '1-305а', '1-309', '1-310']), 4);

INSERT INTO auditorium (number, id_sector) VALUES
    (unnest(array['1-330', '1-331', '1-333', '1-333а', '1-336', '1-338а']), 11);
