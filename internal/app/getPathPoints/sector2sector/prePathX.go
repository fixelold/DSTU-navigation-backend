...
func (s *sectorToSectorController) prePathLeftX(borderPoint, points models.Coordinates) models.Coordinates {
...
func (s *sectorToSectorController) prePathRightX(borderPoint, points models.Coordinates) models.Coordinates {
	var result models.Coordinates
